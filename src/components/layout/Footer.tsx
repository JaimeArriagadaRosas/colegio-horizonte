        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 py-12">
          <div className="space-y-4">
            ...
            <p className="text-gray-300 text-sm leading-relaxed">
              Formando líderes con valores desde 1985. Educación de excelencia con un enfoque
              humano e integral.
            </p>
          ...
          <div>
            <h3 className="font-heading font-semibold text-lg mb-4">Horario de Atención</h3>
        ...
        <div className="border-t border-white/10 py-6">
          <div className="flex flex-col sm:flex-row justify-between items-center gap-4">
            <p className="text-sm text-gray-400">
              © {currentYear} Colegio Horizonte. Todos los derechos reservados.
            </p>
